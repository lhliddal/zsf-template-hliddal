...
% Laute Fläche: die Füllung einer Box mit Kopfzeile. Gegenstück zur ruhigen
% Fläche unten, und aus demselben Grund ein benannter Token: Der Ton muss
% BEIDE Flächen anbieten, damit `weight` zwischen ihnen wählen kann, ohne
% dass eine der beiden Fassungen einen eigenen Farbgriff mitbringt. Stünde
% nur die laute hier, müsste die leise ihre Fläche selbst setzen — und täte
% das zwangsläufig an einer anderen Stelle der Optionsliste als der Ton.
