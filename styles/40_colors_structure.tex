...
% Kein eingebauter \columnbreak. Er stand hier und war der einzige Umbruch im
% System, den der Aufrufer nicht sah und nicht abschalten konnte: »Front-Kapitel«
% ist eine Aussage über Nummerierung und Farbe, nicht über Spalten. Wer ein
% Kapitel auf einer neuen Spalte will, setzt \ZSFNewColumn davor — derselbe
% sichtbare Weg wie bei jedem anderen Kapitel, und der einzige.
%
% Der Umbruch war zudem nur über einen privaten Zähler (zsfFirstChap) zu
% umgehen, den ausschliesslich er brauchte; \StartChapter trug einen Zweig, der
% nichts tat, ausser ihn zu pflegen. Umgangen wurde er in einer Fach-ZSF per
% \setcounter{zsfFirstChap}{1} in einer KAPITELDATEI — also mit Layout an einem
% Ort, an dem rules/10_architecture keines duldet.
