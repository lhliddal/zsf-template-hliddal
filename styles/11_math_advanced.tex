...
% --- Areafunktionen ---
% Die Umkehrungen der Hyperbelfunktionen. TeX bringt dafuer nichts mit, und ein
% \operatorname im Kapitel meldet der Linter zu Recht: Ein mehrfach gebrauchter
% Operator gehoert einmal hierher. Aus einer Fach-ZSF zurueckgeflossen, die sie
% an 14 Stellen brauchte — sie sind nicht fachspezifisch, sondern fehlen jeder
% Analysis- und den meisten Physik-ZSF gleichermassen.
