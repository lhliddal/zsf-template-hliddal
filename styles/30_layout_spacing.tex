...
% optisch an der Kante an. Aus \ZSFspaceXS abgeleitet statt roh gesetzt,
% damit die Pillen der Dichte folgen wie alles andere Vertikale.
...
%
% Der Faktor darauf ist die Stellschraube der ZSF. Er existiert, weil die
% Messung grosszügig ist: Sie reserviert die volle Höhe der Footer-Ziffer plus
% Inset plus einen Blockabstand, und das ist mehr, als das Overlay zum
% Nicht-Überdrucken braucht. Eine box-lastige ZSF gewinnt hier Spaltenhöhe auf
% JEDER Seite, und der Preis ist ein knapperer, aber weiterhin freier Fuss.
%
% Ein Faktor und kein setzbares Register: Die Messung soll einer Änderung der
% Footer-Schrift weiter folgen — ein roher Wert in preamble.tex bliebe stehen
% und liefe still gegen eine grössere Schrift. Damit verhält sich die Clearance
% wie \ZSFDensityFactor und \ZSFBarGapFactor: Faktor auf eine berechnete Basis.
\providecommand{\ZSFFooterClearanceFactor}{1}
...
% Der Abstand VOR einem Block, wenn KEIN Balken vorausging. Im Balkenfall
% verbraucht \ZSF@blockBefore stattdessen direkt \ZSFbarAfterGap und erreicht
% diesen Wert nicht. Ein Balken-Zweig an diesem Register wäre daher doppelte
% Zuständigkeit.
