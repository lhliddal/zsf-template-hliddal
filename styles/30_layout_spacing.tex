...
% ZSF früher oder später umbrechen lassen will, dreht deshalb den Faktor —
% vorher musste man drei Register einzeln anfassen und dabei ihr Verhältnis
% von Hand wahren. Grösser = die Spalte bricht eher vorzeitig um und lässt
...
% in \ZSFfigside). Stand vorher als nackte 0.97 bzw. 0.96 in styles/60_boxes —
% zwei Werte für dieselbe Absicht, um einen Punkt verschieden, ohne dass ein
% Grund dokumentiert war. Als Makro statt \newlength: es ist ein Faktor, kein
...
% zweier Registersätze mit verschiedenen Präfixen wie früher (proc/list).
...
\newlength{\ZSFboxPadYTight} \setlength{\ZSFboxPadYTight}{\ZSFDensityBoxes\ZSFspaceXS}
