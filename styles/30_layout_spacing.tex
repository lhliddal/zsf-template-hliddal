...
% Skaliert die vier Basisregister; sämtliche abgeleiteten Masse folgen
% automatisch (Box-Paddings, Section-Gaps, \tabcolsep, Display-Skips),
% weil sie aus diesen Registern berechnet werden.
