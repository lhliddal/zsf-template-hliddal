...
% gelten und nicht zusätzlich der normale Blockabstand. Der Merker hält fest,
% ob eine ChapterBar vorausging (ein Abschnittsbalken zieht dann seinen
% Vorabstand zusammen); \ZSF@blockBefore (60_boxes) verbraucht ihn — für
% JEDEN Block, Box wie runintext.
%
...
%
% Daneben stand lange ein zweiter, \ifzsfAfterChapterBar, mit vier eigenen
% Makros und fünf Aufrufstellen — er sagte dasselbe, nur auf den Kapitelbalken
% eingeschränkt. Diese Einschränkung war ohne Wirkung: Sein einziger Leser war
% \ZSFCollapseAfterChapterBar, gerufen ausschliesslich aus dem
% Subsection-Balken, und dort stossen zwei Balken entweder aneinander oder
% nicht — welcher davor stand, ändert die Antwort nicht.
...
% Der Balkenfall steht nicht hier: Dort hat \ZSFTitleBarAfter den Abstand
% bereits gesetzt, und \ZSF@blockBefore ruft dieses Makro deshalb nur im
% \else. Ein Zweig für \ZSFbarAfterGap wäre unerreichbar — er stand hier und
% war es auch.
