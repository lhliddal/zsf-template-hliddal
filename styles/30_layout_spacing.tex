...
\newlength{\ZSFspaceSep}  \setlength{\ZSFspaceSep}{\ZSFDensityBoxes\dimexpr
...
\setlength{\ZSFparskipBase}{\ZSFDensityFactor\dimexpr 3.5pt\relax
                    plus \ZSFDensityFactor\dimexpr 1pt\relax
                   minus \ZSFDensityFactor\dimexpr 0.5pt\relax}
\setlength{\parskip}{\ZSFDensityText\ZSFparskipBase}
...
\newlength{\ZSFsubsectionBarBeforeSkip}\setlength{\ZSFsubsectionBarBeforeSkip}{\ZSFDensityStructure\ZSFspaceL}
\newlength{\ZSFsubsubsectionBarBeforeSkip}\setlength{\ZSFsubsubsectionBarBeforeSkip}{\ZSFDensityStructure\ZSFspaceS}
\newlength{\ZSFsubsectionAfterChapterGap}\setlength{\ZSFsubsectionAfterChapterGap}{\ZSFDensityStructure\ZSFspaceXS}
\newlength{\ZSFsubsectionAfterGap}\setlength{\ZSFsubsectionAfterGap}{\ZSFDensityStructure\ZSFspaceXS}
\newlength{\ZSFchapterBarAfterSkip}\setlength{\ZSFchapterBarAfterSkip}{\ZSFDensityStructure\dimexpr
...
\newlength{\ZSFlistMarkGap}         \setlength{\ZSFlistMarkGap}{\ZSFspaceXS}
\newlength{\ZSFlistItemSep}         \setlength{\ZSFlistItemSep}{\ZSFspaceXS}
...
\newlength{\ZSFtextMinPad}\setlength{\ZSFtextMinPad}{\ZSFDensityBoxes\ZSFspaceXS}
...
\newlength{\ZSFboxPadX}      \setlength{\ZSFboxPadX}{\ZSFDensityBoxes\ZSFspaceS}
\newlength{\ZSFboxPadXBar}   \setlength{\ZSFboxPadXBar}{\ZSFDensityBoxes\ZSFspaceM}
\newlength{\ZSFtableEdgePad} \setlength{\ZSFtableEdgePad}{\ZSFDensityTables\ZSFspaceM}
\newlength{\ZSFtableEdgePadTight}
  \setlength{\ZSFtableEdgePadTight}{\ZSFDensityTables\ZSFspaceXS}
...
\newlength{\ZSFboxPadY}      \setlength{\ZSFboxPadY}{\ZSFDensityBoxes\ZSFspaceS}
\newlength{\ZSFBoxAfterSkip} \setlength{\ZSFBoxAfterSkip}{\ZSFDensityBoxes\ZSFspaceS}
...
% einstellen lassen.
\newlength{\ZSFbarPadY}      \setlength{\ZSFbarPadY}{\ZSFDensityStructure\ZSFspaceS}
\newlength{\ZSFbarPadYTight} \setlength{\ZSFbarPadYTight}{\ZSFDensityStructure\ZSFspaceXS}
...
\newlength{\ZSFvaluegridRowSep}       \setlength{\ZSFvaluegridRowSep}{\ZSFDensityTables\ZSFspaceSep}
