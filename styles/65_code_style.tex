...
% `frame=soft` ist hier Pflicht und nicht Kosmetik: Dieser Stil erbt von
% `zsfbox` (Fluss) statt von `zsfboxshape` (Form) und bekommt die Rahmenwahl
% deshalb nicht mit. Ohne die Zeile trüge ein Codebox-Teil die Wahl der
% vorhergehenden Box weiter.
