...
\NewDocumentEnvironment{ZSF@box}{m m m}{%
  ...
  \begin{tcolorbox}[#1, zsftitle={#2}, #3, ZSF@resolveframe]%
}{%
  \end{tcolorbox}%
}
\makeatother
...
% zu werden. Anders als beim Rahmen ist das hier richtig: Die ruhige Fläche IST
% die Aussage von `weight=quiet` und soll den Flächenwert des Tons verdrängen,
% während der Rahmen umgekehrt beides zusammenführen muss.
\tcbset{
  weight/.is choice,
  weight/loud/.style ={
