...
% `frame=soft`, `ZSF@surface=auto` und `ZSF@titlefill=tone` stehen hier, damit
% jede Box die verzögert aufgelösten Wahlen zurücksetzt. Ohne diese Zeilen
% trüge eine Box die Wahl der vorhergehenden weiter, sobald sie selbst keine
% trifft — die Regler merken sich die Absicht ja in Makros.
...
\NewDocumentEnvironment{ZSF@box}{m m m}{%
  ...
  \begin{tcolorbox}[#1, zsftitle={#2}, ZSF@weightBase, #3,
                    ZSF@resolveframe, ZSF@resolvesurface]%
}{%
  \end{tcolorbox}%
}
\makeatother
