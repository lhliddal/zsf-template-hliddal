...
%
% Herkunft: konsolidiert aus zsf-informatik2-fs2026/styles/67_code_comments.tex.
% ============================================================
...
% erben die Code-Schriftgrösse (kein \small), damit Code und Kommentar
...
% von einem Zeilenumbruch, sodass die nächste \CodeLine-Zeile
...
% Threshold-API
% ------------------------------------------------------------
% Persistent: bleibt bis zum nächsten Reset oder Gruppen-Ende.
