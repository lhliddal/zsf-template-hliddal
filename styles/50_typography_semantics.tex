...
% Explizite bp-Größen (wie Analysis) für präzise, font-unabhängige Kontrolle
...
% Semantische Tabellen-Fontgrößen
...
%
% \ZSFkeyword{...} — hebt zentrale Fachbegriffe im Fließtext hervor.
% Verwendung:
...
%     Fachbegriffe (Gesetze, Effekte, Bauteile, zentrale Größen)
