...
\newcommand{\ZSFfontDiagramLabelSmall}{\sffamily\fontsize{4.6bp}{5.1bp}\selectfont}
...
%
% VERSCHIEDEN vorbelegt, und das ist der Punkt: \ZSFkeyword ist laut
% rules/25_structure_markers der PRIMÄRE Scan-Anker, \ZSFlabel ausdrücklich
% keiner. Rendern beide fett, ist der wichtigste Anker der ZSF von jeder
% beliebigen Beschriftung nicht zu unterscheiden — und Auffindbarkeit unter
% Zeitdruck ist das oberste Ziel (rules/00_meta).
%
% Warum ausgerechnet die Kapitelfarbe: Die anderen billigen Signale sind
% vergeben — fett+unterstrichen ist \ZSFhl, die rote Pille \ZSFdanger, der
% Pfeil \ZSFconclusion. Die Farbe ist frei und trägt im System bereits die
% Bedeutung »dieses Kapitel« (Balken, Akzente, Verweis-Locator); der Anker
% fügt damit keine neue Farbdimension hinzu, sondern nutzt die vorhandene.
%
% \chaptercolor statt eines eigenen Tokens, damit der Anker der Kapitelrotation
% folgt wie jedes andere farbtragende Element. Umstellen pro ZSF in
% preamble.tex per \renewcommand, nie im Kapitel.
% Die Farbe läuft über \ZSFInk: In einem Titelbalken oder einer Tabellenkopfzelle
% besitzt die Fläche die Farbe bereits, und der Anker erbt dort deren
% Kontrastfarbe, statt in ihr zu verschwinden (40_colors_structure → Ink-Vertrag).
\newcommand{\ZSFkeywordStyle}[1]{\textbf{\ZSFInk{\chaptercolor}{#1}}}
