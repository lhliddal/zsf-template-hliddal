...
% ------------------------------------------------------------
% EINE Umgebung mit Reglern statt dreier fast gleicher Varianten
% (rules/02_ai_mandate → Katalog-Ökonomie). Früher: ZSFtable /
% ZSFtableFlat / ZSFtablePlain — drei Namen für zwei Ja/Nein-Fragen.
%
...
% Zeile 2, ohne ab Zeile 1. Genau das war der einzige echte Unterschied
% zwischen ZSFtable und ZSFtableFlat.
%
