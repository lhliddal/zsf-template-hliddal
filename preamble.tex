...
% anbietet (7pt). Der grösste der drei Hebel: ~30 % Fläche zwischen 8pt und 7pt.
...
%
% Wie laut die verbindende Prosa neben dem Bausteininhalt steht — ein
% ROLLEN-Faktor auf die Grundgrösse, für blanken Text zwischen den
% Strukturmakros, `runintext` und das Register. Boxen, Tabellen, Balken und
% Titel bleiben unberührt. In einer box-lastigen ZSF trägt die Box den
% prüfungsrelevanten Inhalt und die Prosa verbindet ihn — dann darf sie eine
% Stufe leiser stehen. 0.875 = 7pt bei 8pt Grundgrösse.
% \def\ZSFFlowTextScale{0.875}    % 1 = wie der Bausteininhalt
%
...
%
% Freiraum am Satzspiegel-Fuss für das Footer-Overlay. Die Referenz misst die
% Footer-Ziffer plus Inset plus einen Blockabstand und ist bewusst grosszügig;
% kleiner heisst mehr Spaltenhöhe auf JEDER Seite bei knapperem, aber weiter
% freiem Fuss. Ein Faktor und kein Mass, damit die Messung einer geänderten
% Footer-Schrift weiter folgt.
% \def\ZSFFooterClearanceFactor{1} % 1 = Referenz, kleiner = mehr Spaltenhöhe
%
