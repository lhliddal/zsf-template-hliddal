...
\begin{formulabox}[Dritte Stufe: Titel über der Box\ZSFTitleTag{weight=caption}][weight=caption]
  $\displaystyle \frac{\dd}{\dd x}\left(u\cdot v\right) = u'v + uv'$
\end{formulabox}
\textNachBox{\ZSFkeyword*{weight=caption} hebt den Titel als leichte Zeile aus
der Box heraus; die Box selbst behält ihre Form. Für die beschriftete Formel —
den häufigsten Fall einer Formelsammlung.}
