...
\StartFrontChapter[Start]{Living Showcase}
...
% Front-Matter IST indexierbar, sobald das Kapitel einen Kurzwegweiser trägt
% (oben: [Start]). Ohne ihn erbte der Eintrag still die Nummer eines fremden
% Kapitels — deshalb meldet check_index.sh genau diesen Fall.
\ZSFindex{Schnellzugriff}
...
\begin{tablebox}[Welcher Baustein wo\ZSFTitleTag{Übersicht}]
  \begin{ZSFtable}{Y{1.05} Z{0.35} Y{1.60}}
    ...
    Aussagen & \ZSFsectionref{ch:boxes} & defbox (weight, tone), warnbox \\
    Verfahren & \ZSFsectionref{ch:lists} & ZSFlist (ordered) \\
...
\begin{defbox}[Lesart][weight=quiet]
