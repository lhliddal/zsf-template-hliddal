...
\begin{statementbox}[Operatoren des Opt-in-Moduls\ZSFTitleTag{11\_math\_advanced}]
  ...
  \]
  % \drawbrace/\annote zeichnen als TikZ-Overlay und belegen deshalb keine
  % Höhe — der Platz unter dem Term muss von Hand reserviert werden, sonst
  % läuft die Klammer in das nächste Element.
  \ZSFgap[L]\ZSFgap[M]
\end{statementbox}
