...
\begin{formulabox}[Was die Formelbox kann\ZSFTitleTag{formulabox}]
  ...
  \]
  \ZSFsep[ZSFsep mit Beschriftung gliedert die Box]
  \[
...
\begin{goalbox}[Zielkette in zwei Schreibweisen\ZSFTitleTag{goalbox}]
  ...
  \ZSFsep[Frei aus den Primitiven gebaut]
...
\begin{defbox}[Operatoren des Opt-in-Moduls\ZSFTitleTag{11\_math\_advanced}][weight=quiet]
  \[
    \begin{aligned}
      ...
      &\Arsinh x,\quad \Arcosh x,\quad \Artanh x.
    \end{aligned}
  \]
  ...
  \annote[yshift=-\ZSFspaceM]{brace-\thebrace}{\ZSFfontDiagramLabel Pivotspalten}
  \ZSFbraceRoom
\end{defbox}
