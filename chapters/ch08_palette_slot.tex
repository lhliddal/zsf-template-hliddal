...
\StartChapterOnNewColumn[ch:stilmittel]{Stilmittel}
...
\begin{formulabox}[title={Wohin wandert welcher Koeffizient?}]
  \[
...
\begin{factlist}
  \ZSFFact{ZSFmhlA/B/D}{Die gegebenen Grössen, je ein Strang.}
  \ZSFFact{ZSFmhlC}{Das Ziel — immer die Endform oder das Resultat.}
  \ZSFFact{Gleiche Farbe}{bedeutet immer dieselbe Grösse, nie blosse Betonung.}
\end{factlist}

\SubsectionBar[sec:brace]{Formelteile benennen}
\ZSFindex{Klammer-Annotation}

\begin{formulabox}[title={Der Name steht am Teil, nicht daneben}]
  \[
...
\begin{formulabox}[title={Farbe, Klammer und Hervorhebung zusammen}]
  \[
    \begin{aligned}
