...
\begin{defbox}[Kommentar rechts oder darüber\ZSFTitleTag{CodeLine}][weight=quiet]
  \ttfamily
...
\begin{ZSFlist}
  \ZSFItem{\ZSFkeyword{CodeLine}}{Entscheidet nach Breite, wo der Kommentar steht.}
  \ZSFItem{SetCodeCommentThreshold}{Verschiebt die Schwelle für den Umbruch.}
  \ZSFItem{ResetCodeCommentThreshold}{Stellt den Standard wieder her.}
\end{ZSFlist}
