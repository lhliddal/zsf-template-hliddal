...
\begin{tablebox}[Umgebungen]
  \begin{ZSFtable}[font=dense, rows=tight, colsep=tight]{Y{1.5} Z{0.6}}
...
\begin{tablebox}[Alle in der Box-Fabrik]
  \begin{ZSFtable}[font=dense, rows=tight, colsep=tight]{Y{1.05} Y{1.25} Z{0.55}}
...
\begin{tablebox}[30\_layout\_spacing.tex · 14]
  \begin{ZSFtable}[font=dense, rows=tight, colsep=tight]{Y{1.5} Z{0.6}}
    \ZSFheaderRow \ZSFhead{Name} & \ZSFhead{ID} \\
