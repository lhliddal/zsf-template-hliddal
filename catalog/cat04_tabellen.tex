...
\begin{runintext}
  Eine Tabellen-Umgebung mit sechs Reglern, dazu das kompakte
...
\begin{tablebox}[D-08 · ZSFspan]
  \begin{ZSFtable}{Y{1.4} Z{0.9} Z{0.9} Z{0.8}}
...
\begin{tablebox}[D-10 · grid=horizontal]
  \begin{ZSFtable}[grid=horizontal]{Y{1.0} Q{1.0}}
    \ZSFheaderRow \ZSFhead{Erste} & \ZSFhead{Zweite} \\
    Mustertext & zum Formvergleich \\
  ...
  \end{ZSFtable}
\end{tablebox}
\Zweck{Ohne Senkrechte. Vorbelegung ist both; die Aussenkante zeichnet in
jedem Fall der Boxrahmen, nicht das Gitter.}

\begin{tablebox}[D-11 · grid=none]
  \begin{ZSFtable}[grid=none]{Y{1.0} Q{1.0}}
    \ZSFheaderRow \ZSFhead{Erste} & \ZSFhead{Zweite} \\
    Mustertext & zum Formvergleich \\
  ...
  \end{ZSFtable}
\end{tablebox}
\Zweck{Gar keine Linien — wo die Spalten selbst sprechen und das Zebra
trennt. Derselbe Regler mit denselben Werten wie am valuegrid.}

\SubsectionBar[kat:tab-spalten]{Spaltentypen}
\ZSFindex{Spaltentyp}

\begin{tablebox}[D-12 · L C R F]
...
\begin{tablebox}[D-13 · Y Z Q mit Gewicht]
...
\begin{valuegrid}[D-14 · valuegrid]{3}
  Mustertext & 12 & 24 & 36 \\
  Zweite Zeile & 20 & 40 & 60 \\
...
\begin{valuegrid}[D-15 · valuegrid rows=tight][rows=tight, colsep=tight]{3}
  Mustertext & 12 & 24 & 36 \\
  Zweite Zeile & 20 & 40 & 60 \\
  Dritte Zeile & 30 & 60 & 90
\end{valuegrid}
